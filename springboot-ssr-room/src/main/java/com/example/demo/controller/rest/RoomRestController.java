...
@RestController
@RequestMapping("/rest/room")	// 統一前綴
@CrossOrigin(origins = {"http://localhost:8082", "http://localhost:8083"})	// 限定可存取位置
...
*/
	...
	public ResponseEntity<ApiResponse<Void>> handleRoomExecptions(RoomException e){
